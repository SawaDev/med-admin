                        ...
                        <div className="h-[300px] flex flex-col justify-between overflow-y-auto">
                                ...
                                <div className="flex flex-col items-center gap-2">
                                  ...
                                  {handleNew && (
                                    <Button
                                      onClick={handleNew}
                                      variant={"outline"}
                                      className="sticky bottom-0 w-fit flex gap-1 justify-center items-center"
                                    >
                          ...
                          {options.length > 0 && handleNew && (
                            <div className="sticky bottom-0 w-full">
                              <Button
                                onClick={handleNew}
                                className="w-full flex my-1 gap-1 justify-center items-center"
                              >
                                <PlusCircle className="w-4 h-4" />
                                Yangi Qo'shish
                              </Button>
